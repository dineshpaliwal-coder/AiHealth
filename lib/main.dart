...
import 'package:ai_health/login_page/login_page_widget.dart';
import 'flutter_flow/flutter_flow_theme.dart';
...
class _MyAppState extends State<MyApp> {
  Stream<AiHealthFirebaseUser> userStream;
  AiHealthFirebaseUser initialUser;
  ...
  void initState() {
    super.initState();
    userStream = aiHealthFirebaseUserStream()
